  ...
  return (
    <div className="w-64 h-screen border-r border-gray-200 bg-white flex flex-col">
            ...
            <li key={item.name}>
              <Link 
                ...
                className={`flex items-center px-2 py-2 rounded-md text-sm ${
                  location.pathname === item.path ? 'text-[#855ECB] bg-muwakkil-light font-medium' : 'text-gray-700 hover:bg-gray-100'
                }`}
              >
          ...
          {recentChats.map(chat => (
            <Link 
              ...
              className={`flex items-center mb-2 px-2 py-2 rounded-md text-sm ${
                isActiveChatPath(chat.path) ? 'text-[#855ECB] bg-muwakkil-light font-medium' : 'text-gray-700 hover:bg-gray-100'
              }`}
            >
      ...
      <div className="p-4">
        <Link 
          to="/app/chat" 
          className="w-full flex items-center justify-center px-4 bg-[#855ECB] hover:bg-[#7346b5] text-white rounded-md transition-colors py-[8px]"
        >
