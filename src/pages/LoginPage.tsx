    ...
    <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
      <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
        <div className="mb-6 text-center">
          ...
          <p className="text-gray-600 mt-2">Sign in to your Muwakkil account</p>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm">
              <Link to="/forgot-password" className="font-medium text-muwakkil-purple hover:text-purple-600">
          ...
          <div>
            <button
              type="submit"
              className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-muwakkil-purple hover:bg-purple-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-muwakkil-purple"
            >
              Sign in
            </button>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            ...
            <Link to="/signup" className="font-medium text-muwakkil-purple hover:text-purple-600">
              Sign up
            </Link>
          </p>
        </div>
